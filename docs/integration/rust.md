...
**Demo 项目**：[github.com/browsersdk/brosdk-sdk-rust](https://github.com/browsersdk/brosdk-sdk-rust)
...
从 [crates.io](https://crates.io/crates/brosdk-sdk) 安装（推荐）：
...
```toml
brosdk-sdk = { path = "../brosdk-sdk-rust", default-features = false }
```

## 动态库放置

从 [github.com/browsersdk/brosdk-sdk/releases](https://github.com/browsersdk/brosdk-sdk/releases) 下载原生库，并放置到项目指定目录：
...
- **Rust SDK**：[github.com/browsersdk/brosdk-sdk-rust](https://github.com/browsersdk/brosdk-sdk-rust)
