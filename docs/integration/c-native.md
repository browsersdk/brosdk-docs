...
| 组件 | 说明 | 下载地址 |
| --- | --- | --- |
| **SDK** | C++ 动态链接库，核心调用接口 | [brosdk](https://github.com/browsersdk/brosdk/releases) |
| **SDK Demo** | 完整的使用示例 | [browser-demo](https://github.com/browsersdk/browser-demo) |
| **Rust SDK & Demo** | Rust 语言封装 | [brosdk-rust](https://github.com/browsersdk/brosdk-rust) |
| **TypeScript SDK** | TypeScript/Node.js 封装 | [brosdk-typescript](https://github.com/browsersdk/brosdk-typescript) |
| **TypeScript Demo** | TypeScript/Node.js SDK 封装 | [brosdk-typescript-demo](https://github.com/browsersdk/brosdk-demo) |
...
- [SDK Demo](https://github.com/browsersdk/browser-demo) - 完整的示例项目
